...
var gitRawReleasePathRe = regexp.MustCompile(`^/[a-zа-яA-ZА-Я0-9_.-]+/[a-zа-яA-ZА-Я0-9_.-]+/(?:(?:git-(?:(?:upload)|(?:receive))-pack$)|(?:info/refs$)|(?:HEAD$)|(?:objects/)|(?:raw/)|(?:releases/download/))`)
var lfsPathRe = regexp.MustCompile(`^/[a-zа-яA-ZА-Я0-9_.-]+/[a-zа-яA-ZА-Я0-9_.-]+/info/lfs/`)
